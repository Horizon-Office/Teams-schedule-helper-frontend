...
import { HOME_FACULTIES, type FacultyKey } from '../configs/homeConfig';

type HomeSidebarProps = {
  searchHighlightGroup: string | null;
};

export function HomeSidebar({ searchHighlightGroup }: HomeSidebarProps) {
  const FACULTIES = HOME_FACULTIES;
