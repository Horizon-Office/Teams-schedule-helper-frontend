...
import { SCHEDULE_FACULTIES, type FacultyKey } from '../configs/scheduleConfig';

type ScheduleSidebarProps = {
  searchHighlightGroup: string | null;
};

export function ScheduleSidebar({ searchHighlightGroup }: ScheduleSidebarProps) {
  const FACULTIES = SCHEDULE_FACULTIES;
